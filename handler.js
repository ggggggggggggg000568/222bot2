    ...
    try {
        ...
        try {
            ...
            if (user) {
                ...
                if (!('divorziato' in user)) user.divorziato = false
        ...
        // User privileges - QUESTA È L'UNICA DICHIARAZIONE
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        unreg: 'Devi essere registrato per usare questo comando 📝',
    }[type]    
    if (msg) {
